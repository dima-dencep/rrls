...
public abstract class NeoForgeLoadingOverlayMixin extends LoadingOverlay implements OverlayExtender {
    @Shadow
    @Final
    ...
    public void rrls$render(GuiGraphics context, int mouseX, int mouseY, float delta, CallbackInfo ci) {
        ...
        if (context instanceof DummyGuiGraphics || RrlsConfig.INSTANCE.skipForgeOverlay.get() || earlyLoadingScreenClosed) {
